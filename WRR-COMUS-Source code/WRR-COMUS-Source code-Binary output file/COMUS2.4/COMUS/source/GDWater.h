...
protected: //运行变量
	...
	CFile m_HeadOutFile;                       //水头模拟结果输出文件(二进制)
	CFile m_HDownOutFile;                      //降深模拟结果输出文件(二进制)
	CFile m_FLowOutFile;                       //流量模拟结果输出文件(二进制)
	CFile m_CellBDOutFile;                     //网格单元水量平衡分项模拟结果输出文件(二进制)
...
protected: //内部功能函数
	...
	void OutPutFlowTXT();                                   //输出网格单元流量模拟结果(二进制)
	void OutPutCellBDTXT();                                 //输出网格单元水量平衡模拟结果(二进制)
